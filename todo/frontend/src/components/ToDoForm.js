    ...
    render() {
        ...
        return (
            <form onSubmit={(event) => this.handleSubmit(event)}>
                <div className="field">
                    <h3>{this.props.edit ? 'Редактирование задачи' : 'Создание новой задачи'} для проекта: {this.otherData.projectInfo.name} ({this.otherData.projectInfo.id})</h3>
                </div>
                <br />
                <div className="field">
                    <label className="label-for-field" for='name'>Заголовок задачи:</label>
                    <input type='text' className="form-control" name="title" value={this.state.title} onChange={(event) => this.handleChange(event)} />
                </div>
                <div className="field">
                    <label className="label-for-field" for='description'>Описание задачи:</label>
                ...
                <div className="field">
                    <label className="label-for-field" for='scheduledDate'>Ожидаемая дата завершения:</label>
                ...
                <div className="field">
                    <label className="label-for-field" for='actualDate'>Дата завершения работ по факту:</label>
                ...
                <div className="field">
                    <label className="label-for-field" for='addDate'>Дата и время добавления задачи:</label>
                ...
                <div className="field">
                    <label className="label-for-field" for='isActive'>Задача на исполнении</label>
                ...
                <div className="field">
                    <label className="label-for-field" for='isClose'>Задача завершена</label>
                ...
                <div className="field">
                    ...
                    <label className="label-for-field">Доступные пользователи на проекте:</label>
                ...
                <div className="field">
                    <h3>Дата последнего изменения: {this.state.lastModified}</h3>
                </div>
            </form>
        )
    }
